...
class Manage:
    ...
    @cherrypy.expose
    def massEditSubmit(self, paused=None, anime=None, flatten_folders=None, quality_preset=False,
        ...
        for curShow in showIDs:
            ...
            curErrors += Home().editShow(curShow, new_show_dir, anyQualities, bestQualities, new_flatten_folders, new_paused, new_anime, directCall=True)
...
class ConfigGeneral:
    ...
    @cherrypy.expose
    def saveAddShowDefaults(self, defaultFlattenFolders, defaultStatus, anyQualities, bestQualities, anime):
        ...
        sickbeard.FLATTEN_FOLDERS_DEFAUL = int(defaultFlattenFolders)
    ...
    def saveProviders(self, nzbmatrix_username=None, nzbmatrix_apikey=None,
        ...
        for curProviderStr in provider_str_list:
            ...
            if curProvider == 'nzbs_r_us':
                ...
                sickbeard.NYAATORRENTS = curEnabled
...
class NewHomeAddShows:
    ...
    def addNewShow(self, whichSeries=None, tvdbLang="en", rootDir=None, defaultStatus=None,
        ...
        # add the show
        sickbeard.showQueueScheduler.action.addShow(tvdb_id, show_dir, int(defaultStatus), newQuality, flatten_folders, tvdbLang, anime) #@UndefinedVariable
...
class Home:
    ...
    @cherrypy.expose
    def editShow(self, show=None, location=None, anyQualities=[], bestQualities=[], flatten_folders=None, paused=None, anime=None, blackWords=None, whiteWords=None, blacklist=None, whitelist=None, directCall=False, air_by_date=None, tvdbLang=None):
